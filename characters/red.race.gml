...
#define race_ultra_text
	switch(argument0){
		case 1: return "GAIN A SECOND REVOLVER, AND DOUBLE THE AMOUNT OF AMMO YOU GET FROM STOCKPILES.#@wRESERVE AMMO IS INCREASED TO 24.";
		case 2: return "INCREASE THE EFFECT OF YOUR PASSIVE THE LOWER YOUR HP IS. AT 1/2 OR LESS HP, #@wINCREASE THE DAMAGE DEALT BY LAWBRINGER'S MIGHT.";
